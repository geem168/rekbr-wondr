...
const StepKomplainDibatalkan = ({ waktuKomplain, waktuDibatalkan }) => {
    return (
        <>
            ...
            <li className="relative">
                <div className="relative flex items-start space-x-3">
                    ...
                    <div className="min-w-0 flex-1">
                        <div>
                            <div className="text-sm">
                                <span className="font-medium text-red-600">Komplain Dibatalkan</span>
                            </div>
                            <p className="mt-0.5 text-sm text-gray-500">{waktuDibatalkan}</p>
                        </div>
                        <div className="mt-2 text-sm text-gray-700">
                            <p>Komplain telah dibatalkan oleh buyer</p>
                        </div>
                    </div>
                </div>
            </li>
...
export default StepKomplainDibatalkan; 