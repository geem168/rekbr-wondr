...
const StepBuyerAjukanKonfirmasiNew = ({ waktuKomplain, waktuSellerSetuju, waktuAdminSetuju, waktuBuyerKirimResi, waktuBuyerAjukanKonfirmasi, isSellerSetuju, isAdminSetuju }) => (
    <>
        ...
        <li className="relative pb-10">
            ...
            <div className="relative flex items-start space-x-3">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-2 text-sm text-gray-700">
                        <p>Buyer telah mengajukan konfirmasi penerimaan barang</p>
                    </div>
                </div>
            </div>
        </li>

        {/* Step 6: Menunggu Persetujuan Admin */}
        <li className="relative">
            <div className="relative flex items-start space-x-3">
                ...
                <div className="min-w-0 flex-1">
                    <div>
                        <div className="text-sm">
                            <span className="font-medium text-blue-600">Menunggu Persetujuan Admin</span>
                        </div>
                        <p className="mt-0.5 text-sm text-gray-500">Menunggu admin untuk menyetujui atau menolak konfirmasi</p>
                    </div>
                    <div className="mt-2 text-sm text-gray-700">
                        <p>Admin sedang mempertimbangkan konfirmasi dari buyer</p>
                    </div>
                </div>
            </div>
        </li>
...
export default StepBuyerAjukanKonfirmasiNew; 