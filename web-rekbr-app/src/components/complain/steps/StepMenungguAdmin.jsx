...
const StepMenungguAdmin = ({ waktuKomplain, waktuSellerTolak }) => (
    <>
        ...
        <li className="relative pb-10">
            ...
            <div className="relative flex items-start space-x-3">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-2 text-sm text-gray-700">
                        <p>Seller telah menolak komplain dan akan ditinjau oleh admin</p>
                    </div>
                </div>
            </div>
        </li>

        {/* Step 3: Menunggu Admin */}
            ...
            <div className="relative flex items-start space-x-3">
                ...
                <div className="min-w-0 flex-1">
                    <div>
                        ...
                        <p className="mt-0.5 text-sm text-gray-500">Menunggu admin untuk menyetujui atau menolak komplain</p>
                    </div>
                    <div className="mt-2 text-sm text-gray-700">
                        <p>Admin sedang mempertimbangkan komplain yang ditolak seller</p>
                    </div>
                </div>
            </div>
        </li>
...
export default StepMenungguAdmin; 