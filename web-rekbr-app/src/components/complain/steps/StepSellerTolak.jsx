...
const StepSellerTolak = ({ waktuKomplain, waktuSellerTolak }) => (
    <>
        ...
        {/* Step 3: Menunggu Persetujuan Admin */}
        <li className="relative">
            <div className="relative flex items-start space-x-3">
                ...
                <div className="min-w-0 flex-1">
                    <div>
                        <div className="text-sm">
                            <span className="font-medium text-gray-900">Menunggu Persetujuan Admin</span>
                        </div>
                        <p className="mt-0.5 text-sm text-gray-500">Sedang menunggu</p>
                    </div>
                    <div className="mt-2 text-sm text-gray-700">
                        <p>Admin sedang mempertimbangkan komplain</p>
                    </div>
                </div>
            </div>
        </li>
...
export default StepSellerTolak;
