...
import DataTableBarangHilang from "../components/table/DataTableBarangHilang";
import BarangHilangFilters from "../components/BarangHilangFilters";
...
const BarangHilangPage = () => {
    ...
    const handleDetail = (row) => {
        navigate(`/barang-hilang/${row.id}`, { state: { data: row } });
    };
    ...
    return (
        <div className="p-6">
            <Breadcrumb />
            <h1 className="text-2xl font-bold mb-6">Daftar Komplain Barang Hilang</h1>
